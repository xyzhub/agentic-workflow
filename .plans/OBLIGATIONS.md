...
- [ ] OB-6 · added 2026-08-11 (deferred-obligations `## Closing` OB-c, promoted at the S8 settle close) — do: confirm the five legacy trios still pass lint on the installed release — when: the release lands on the default branch — probe: `node tools/lint.mjs` on a fresh checkout
