...
### Phase 1 — write firewall (D7 shape)
...
### Phase 2 — standing steers (D2/SD4)
...
### Phase 3 — hook (D8) — STRICT checkpoint
...
- **OQ1 — Fix this repo's own `docs/WORKFLOW.md` mirror sites in the same commit?**
