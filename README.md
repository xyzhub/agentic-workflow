...
plugins/venture-workflow/            # the plugin
  ...
  agents/    researcher.md, designer.md, reviewer.md, chronicler.md, backend.md, frontend.md, security.md
  commands/  workflow-init, autonomous, start-work, check-workflow, pre-pr, end-work, quick-fix, retro
