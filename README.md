...
plugins/agentic-workflow/            # the plugin
  ...
  commands/  welcome, brainstorm, bootstrap, adopt, autopilot, plan, mission, counsel, audit, release, verify, settle, operate, publish, sync, ingest, next, doctor, tune, connect, start, check, pr, end, fix, retro, handoff
