...
only (a corrective is counted when it fires, never pre-booked), and justify the
number per phase below. The ledger mirrors this as `Estimate: N sessions`; a rise
is a dated locked decision, never a silent edit._
